...
const HoldItemComponent = ({
  ...
  const deviceOrientation = (0, _hooks.useDeviceOrientation)();
  //#endregion
  ...
  const calculateTransformValue = () => {
    ...
    if (!disableMove) {
      if (isAnchorPointTop) {
        const topTransform = itemRectY.value + itemRectHeight.value + menuHeight + _styleGuide.default.spacing + (safeAreaInsets?.bottom || 0);
  ...
  const GestureHandler = (0, _react.useMemo)(() => {
    switch (activateOn) {
      case `double-tap`:
        ...
        }) => /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNativeGestureHandler.TapGestureHandler, {
          numberOfTaps: 2,
      ...
      default:
        return ({
          children: handlerChildren
        }) => /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNativeGestureHandler.LongPressGestureHandler, {
  ...
  const PortalOverlay = (0, _react.useMemo)(() => {
    return () => /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNativeGestureHandler.TapGestureHandler, {
      numberOfTaps: 1,
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
    children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(GestureHandler, {
      children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNativeReanimated.default.View, {
        ref: containerRef,
      ...
      children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_reactNativeReanimated.default.View, {
        ...
        children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(PortalOverlay, {}), children]
      }, key)
    }, key)]
  });
  //#endregion
...
var _default = exports.default = HoldItem;
