...
const HoldItemComponent = ({
  ...
  const calculateTransformValue = () => {
    ...
    if (!disableMove) {
      if (isAnchorPointTop) {
        const topTransform = itemRectY.value + itemRectHeight.value + menuHeight + styleGuide.spacing + (safeAreaInsets?.bottom || 0);
  ...
  const GestureHandler = useMemo(() => {
    switch (activateOn) {
      case `double-tap`:
        ...
        }) => /*#__PURE__*/_jsx(TapGestureHandler, {
          numberOfTaps: 2,
      ...
      default:
        return ({
          children: handlerChildren
        }) => /*#__PURE__*/_jsx(LongPressGestureHandler, {
  ...
  return /*#__PURE__*/_jsxs(_Fragment, {
    children: [/*#__PURE__*/_jsx(GestureHandler, {
      ...
      children: /*#__PURE__*/_jsxs(Animated.View, {
        ...
        children: [/*#__PURE__*/_jsx(PortalOverlay, {}), children]
      }, key)
    }, key)]
  });
  //#endregion
